...
export default function ChatInterface({
    ...
    switch (msg.role) {
      case "user":
        return (
          ...
          >
            <div className="max-w-[85%] sm:max-w-[70%] lg:max-w-[60%] bg-gradient-to-r from-pink-400 to-pink-500 shadow-md shadow-pink-500/10 text-white rounded-[24px] rounded-tr-[8px] px-6 py-3.5">
        ...
        return (
          ...
          >
            ...
            <div className="w-11 h-11 rounded-full flex items-center justify-center shrink-0
              bg-gradient-to-br from-pink-400 via-purple-400 to-sky-400 shadow-lg shadow-purple-500/20 p-[2px]">
  ...
  return (
    <div className="flex flex-col h-full m-0 relative overflow-hidden bg-transparent w-full">
        ...
        <div className="w-full max-w-4xl space-y-8 flex flex-col">
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-4 animate-slide-up py-12">
            <div className="w-24 h-24 rounded-full flex items-center justify-center mb-6
              bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 shadow-xl border-4 border-white">
      ...
      <div className="absolute bottom-8 left-0 right-0 px-4 sm:px-12 lg:px-32 z-20 flex justify-center">
        <form onSubmit={handleSubmit} className="relative w-full max-w-3xl group">
          {/* Animated Gradient Layer beneath input */}
          <div className="absolute -inset-1 bg-gradient-to-r from-pink-200 via-purple-300 to-sky-200 rounded-[32px] blur-md opacity-30 group-hover:opacity-50 transition duration-500"></div>
          ...
          <div className="relative bg-white/95 backdrop-blur-3xl rounded-[28px] shadow-[0_8px_32px_rgba(0,0,0,0.06)] border border-white/70 p-2 flex flex-col justify-between min-h-[110px]">
            ...
            <div className="flex flex-wrap items-center justify-end px-3 pb-2 gap-2">
              <button
                ...
                className={cn(
                  "flex items-center gap-2 px-6 py-2.5 rounded-full text-[13px] font-bold transition-all duration-300",
                  "bg-gradient-to-r from-pink-400 to-pink-500 text-white shadow-[0_4px_14px_rgba(236,72,153,0.3)]",
                  "hover:shadow-[0_8px_20px_rgba(236,72,153,0.4)] hover:scale-[1.03] active:scale-[0.98]",
